...
stim.VaritionRange = (10.^linspace(0.95,1.8,21))./100;
stim.Var = [1.1 2.1];
...
stim.Reps = 90;  % number of reps per transition condition
...
stim.fName = 'OriRevCorrMasV2_adaptBLKVer2_CJ181_';
...
OriRevCorrStimHartley_Adaptation_Blank_Version2(stim)
