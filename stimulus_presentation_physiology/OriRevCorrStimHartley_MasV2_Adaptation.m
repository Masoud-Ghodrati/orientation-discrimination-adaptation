function OriRevCorrStimHartley_MasV2_Adaptation(stim)
...
ContCounter = 0;
LumCounter = 0;
ContChange = reshape(repmat(rand(ceil(stim.nScene/stim.DeltaStim),1)>0.5,[1 stim.DeltaStim])',1,[]);
LumChange = reshape(repmat(rand(ceil(stim.nScene/stim.DeltaStim),1)>0.5,[1 stim.DeltaStim])',1,[]);
