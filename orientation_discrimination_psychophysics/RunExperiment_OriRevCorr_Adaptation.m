...
stim.AdaptContList = [10 100]/100; % [10 10]/100; list of contrasts (max 2 contrasts)
stim.AdaptLumList = [50 50]/100;  % [20 80]/100; list of luminances (max 2 contrasts)
% 
% stim.AdaptContList = [10 10]/100; % [10 10]/100; list of contrasts (max 2 contrasts)
% stim.AdaptLumList = [90 10]/100;  % [20 80]/100; list of luminances (max 2 contrasts)
...
stim.TestOriDiff = [0.25 0.5 .75 1.5 3 4.5 7.5];  % All so far [0.5 1.5 3 4.5 7.5 12];%[2 4 8 12 16]; %[5:4:30]; % the size of orientation test for stim 2
% stim.TestOriDiff = [0.125 0.25 0.5 .75 1.5 3 4.5];  % Jamie
...
stim.TestISIType = -2; % -1: blank, -2:dynamic noise, -3: static noise
...
stim.NumTrial = [0 0 10 10]+6; %[20 20 14 14];     % number of trials per orientation change condition (e.g., 10 trials for orientation change size of 2 degree between test 1 and 2 stims)
stim.RestEvery = 35;
...
stim.fold = [cd '\'];
stim.fName = 'Behavioral_Exp_Subject_Tim';
% stim.fName = 'Behavioral_Exp_Subject_Lum_Nic';
